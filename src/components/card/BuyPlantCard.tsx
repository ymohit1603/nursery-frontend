...
export const BuyPlantCard: React.FC<BuyPlantCardTypes> = ({ imgUrl, name, discountedPrice, price, cartButton, discount }) => {
    return <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <div className="mt-2 mb-5 flex items-center justify-between">
                    <p>
                        <span className="text-3xl font-bold text-slate-900">Rs. {discountedPrice}</span>
